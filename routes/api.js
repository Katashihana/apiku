...
var fs = require('fs');
var fbdown = require('fb-downloads');
var brainly = require('brainly-scraper');
var nekobocc = require('nekobocc');
var router  = express.Router();
var creator = 'KatashiHana' // ubah jadi nama lu
const listkey = ["katashi","Katashi","putra"]; // ubah apikey nya, tambah aja klo mau
...
router.get('/media/fbdownlo', async (req, res, next) => {
          var apikey = req.query.apikey
       	var url = req.query.url
       	if(!apikey) return res.json(loghandler.apikey)
       if (!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter url"})
